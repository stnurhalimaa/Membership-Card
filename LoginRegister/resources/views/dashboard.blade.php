...
<div class="container mt-5">
    <h1 class="mb-4 fw-bold">Welcome, {{ Auth::user()->name }}!</h1>

    <div class="card shadow-sm mb-4">
        <div class="card-header bg-dark text-white">
            <h3 class="mb-0">Your Membership Cards</h3>
        </div>
        <div class="card-body">
            @if($cards->count() > 0)
            ...
            @else
                <div class="alert alert-info">
                    ...
                    <p>Create your first membership card <a href="{{ route('membership_cards.create') }}">here</a>.</p>
                </div>
            @endif
        </div>
    </div>
    ...
    <div class="text-center">
        <a href="{{ route('membership_cards.create') }}" class="btn btn-primary btn-lg">
            <i class="fas fa-plus"></i> Create New Membership Card
        </a>
    </div>
</div>
